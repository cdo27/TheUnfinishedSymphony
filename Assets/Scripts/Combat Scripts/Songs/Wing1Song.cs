...
public class Wing1Song : Song
{
    public Wing1Song()
    {
        ...
        attackBeatsToHit = new List<BeatData>
        {
            ...
            new BeatData(94f, 2), new BeatData(95f, 2), new BeatData(96f, 1), new BeatData(101f, 1),
            new BeatData(102f, 1), new BeatData(103f, 0), new BeatData(103.5f, 0), new BeatData(104f, 0), new BeatData(105f, 1),
            new BeatData(106f, 1), new BeatData(107f, 2), new BeatData(107.5f, 2), new BeatData(108f, 2),
         ...
         new List<BeatData>
        {
          ...
          new List<BeatData>
        {
            new BeatData(192.5f, 2), new BeatData(193f, 2), new BeatData(193.5f, 2), new BeatData(194f, 2), new BeatData(194.5f, 2) // Defend Phase 8
        }
